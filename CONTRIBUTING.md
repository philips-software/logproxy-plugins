# Contributing to logproxy-plugins

We'd love for you to contribute to our source code and to make the logproxy-plugins even better than it is today!
...
In Github, send a pull request to original master branch: f.e. `logproxy-plugins:master`.
...
[github]: https://github.com/philips-software/logproxy-plugins/issues 
